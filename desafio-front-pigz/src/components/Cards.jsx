...
const Cards = () => {
  return (
    <div className="flex flex-col justify-center items-center text-[#333333] font-poppins gap-8">
      <div className="flex flex-col items-center bg-[#FAFAFA] p-8 rounded-3xl hover:border-solid hover:border-2 hover:border-[#9F9F9F] hover:transition duration-300 w-[60%]">
